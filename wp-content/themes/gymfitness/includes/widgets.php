...
class GymFitness_Clases_Widget extends WP_Widget {
    ...
    /**
     * Aquí definiremos lo que se va a presentar por pantalla
     */
        ...
        <ul class="clases-sidebar">
            <?php
                $args = array(
                    ...
                    /*
                    Podemos agregarle orden y que ordene por título, o rand que va a traer
                    elementos en orden aleatorio, pero este último consume mucha memoria 
                    en el servidor.
                    es recomendable no utilizarlo.
                    'order' => 'ASC',
                    'order_by' => 'title'
                    */
                );
    ...
    /**
     * Aquí definimos el formulario a mostrar en el área del widget que creamos
     */
    public function form( $instance ) {
        $cantidad = !empty($instance['cantidad']) ? $instance['cantidad'] : 
        esc_html('¿Cuántas clases deseas mostrar?');
        ?>
        <p>
    ...
    /**
     * Aquí guardaremos los cambios en este caso sería el valor cantidad
     */
